...
public:
  ...
  /**
   * \brief Attachment of a set of UE devices to the network via the
   *        highest UE RX power from the eNodeB set.
   * \param ueDevices the set of UE devices to be attached
   * \param enbDevices the set of eNodeB devices to be considered
   *
   * This function finds among the eNodeB set the one that provides the
   * UE with the highest RX Power,
   * and then invokes manual attachment between the pair.
   *
   * Users are encouraged to use automatic attachment (Idle mode cell selection)
   * instead of this function.
   ...
   * \sa LteHelper::Attach(NetDeviceContainer ueDevices);
   */
  void AttachRXPowerEnb (NetDeviceContainer ueDevices, NetDeviceContainer enbDevices);

  /**
   * \brief Attach the UE device to the network via the higher
   *        RX power  among those in the set.
   * \param ueDevice the UE device to be attached
   * \param enbDevices the set of eNodeB devices to be considered
   *
   * This function finds among the eNodeB set the one that provides the
   ...
   * \sa LteHelper::Attach(Ptr<NetDevice> ueDevice);
   */
  void AttachRXPowerEnb (Ptr<NetDevice> ueDevice, NetDeviceContainer enbDevices);
